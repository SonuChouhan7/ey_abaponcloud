...
define view entity ZATS_SC_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZATS_SC_BOOKING as _Booking on
    $projection.BookingId = _Booking.BookingId and
    $projection.TravelId = _Booking.TravelId
association[1..1] to ZATS_SC_TRAVEL as _Travel on
