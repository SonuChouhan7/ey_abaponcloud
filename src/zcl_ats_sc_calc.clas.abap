CLASS zcl_ats_sc_calc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ats_sc_calc IMPLEMENTATION.


  METHOD if_sadl_exit_calc_element_read~calculate.
  check not it_original_data is initial.

    data: lt_calc_data type standard table of zats_SC_travel_processor with DEFAULT KEY,
