CLASS lsc_zats_sc_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zats_sc_travel IMPLEMENTATION.
...
CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    types:  t_entity_create type table for create zats_SC_travel,
              t_entity_update TYPE table for update zats_SC_travel,
              t_entity_rep type table for REPORTED zats_SC_travel,
              t_entity_err type table for FAILED zats_SC_travel.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  data : ls_result like line of result.
    ...
    READ ENTITIES OF zats_SC_travel in LOCAL MODE
        ENTITY travel
...
*            ENDIF.
  ...
  METHOD earlynumbering_create.
    ...
    data: entity type STRUCTURE FOR CREATE zats_SC_travel,
...
*        CATCH cx_number_ranges.
  ...
  METHOD copyTravel.
    ...
    DATA:
      travels       TYPE TABLE FOR CREATE ZATS_SC_TRAVEL\\travel,
      bookings_cba  TYPE TABLE FOR CREATE ZATS_SC_TRAVEL\\travel\_booking,
      booksuppl_cba TYPE TABLE FOR CREATE ZATS_SC_TRAVEL\\Booking\_BookingSupplement.
    ...
    MODIFY ENTITIES OF ZATS_SC_TRAVEL IN LOCAL MODE
      ENTITY travel
...
*         entities_c =
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zats_SC_travel
        ENTITY travel
    ...
    READ ENTITIES OF zats_SC_travel
        ENTITY Travel
            ALL FIELDS
                WITH CORRESPONDING #( keys )
