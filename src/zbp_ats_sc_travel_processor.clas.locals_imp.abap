CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS augment_create FOR MODIFY
      ...
      types:  t_entity_create type table for create zats_SC_travel_processor,
          t_entity_update TYPE table for update zats_SC_travel_processor,
          t_entity_rep type table for REPORTED zats_SC_travel_processor,
          t_entity_err type table for FAILED zats_SC_travel_processor.
...
*         entities_c =
  ...
  data: travel_create type table for create zats_SC_travel.
     ...
     MODIFY augmenting entities of zats_SC_travel
     entity travel
