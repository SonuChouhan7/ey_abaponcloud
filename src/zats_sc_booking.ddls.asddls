...
define view entity ZATS_SC_BOOKING as select from /dmo/booking_m
composition[0..*] of ZATS_SC_BOOKSUPPL as _BookingSupplement
association to parent ZATS_SC_TRAVEL as _Travel on
